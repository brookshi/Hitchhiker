Hitchhiker include a distributed stress test system,  you should deploy [Hitchhiker-Node](https://github.com/brookshi/Hitchhiker-Node) to one or more PC before using it.
